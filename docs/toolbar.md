...
on the right while there is room and floats over the table otherwise; whether it is open
    ...
    <div ref="root" :style="rootStyle" class="mx-auto w-full">
        <div class="flex items-start gap-4">
            <DataTable class="min-w-0 flex-1" …>
                <template #toolbar>
                    …
                    <IconButton :label="t('Filters')" size="lg" :tone="filtersOpen ? 'active' : 'quiet'" @click="toggleFilters"><IconFilter /></IconButton>
                </template>
            </DataTable>
